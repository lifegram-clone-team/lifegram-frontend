...
.addImg>.imageUploadSize>img{width:100%;height:100%;object-fit:cover;object-position: center;}
  ...
  /* addPost 게시물 글씨 시작 */
  .addPostWrap > .postSharesWrap > .addPost > .addContents {
    display: flex;
    flex: 1;
  ...
  .addPost > .addContents > .user {
    width: 100%;
    height: 10%;
    display: flex;
    margin-top: 5px;
  }
  .addPost > .addContents > .user > .userProfile {
    width: 100%;
    height: 100%;
    display: flex;
    align-items: center;
  ...
  .addPost > .addContents > .user > .userProfile > .userImg {
    width: 12%;
    height: 100%;
  }
  .addPost > .addContents > .user > .userProfile > .userImg > img {
    width: 100%;
    height: 100%;
    border-radius: 50%;
  }
  .addPost > .addContents > .user > .userProfile > p {
    margin-left: 10px;
  }
  .addPost > .addContents > .user > .userName {
    position: sticky;
  }
  .addPost > .addContents > .contents {
    width: 100%;
    height: 75%;
    position: relative;
    padding-top: 20px;
  }
  .addPost > .addContents > .contents > textarea {
    width: 100%;
    min-height: 300px;
    border: none;
    resize: none;
  ...
  .addPost > .addContents > .contents > p {
    position: absolute;
    width: 100%;
    display: flex;
